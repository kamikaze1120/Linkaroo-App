...
import { ArrowLeft, Zap, QrCode, Edit3, Users, Briefcase, Heart, Shield, Clock, Radar, MapPin } from "lucide-react"
...
export default function NFCSharePage() {
  ...
  const handleDataReceived = (data: any) => {
    ...
    // Convert NFC data to consent request format
  ...
  const handleApproveRequest = (permissions: any) => {
    console.log("Approved NFC connection:", permissions)
    setPendingRequest(null)
  }

  const handleRejectRequest = (reason: string) => {
    console.log("Rejected NFC connection:", reason)
    setPendingRequest(null)
  }

  const handleBlockUser = () => {
    console.log("Blocked NFC user")
    setPendingRequest(null)
  }
      ...
      <div className="bg-white border-b border-gray-200 px-4 py-3">
        <div className="flex items-center justify-between">
          <div className="flex items-center space-x-3">
            ...
            <div>
              <h1 className="text-lg font-semibold">NFC Tap-to-Share</h1>
              <p className="text-sm text-gray-500">Instant contact sharing</p>
            </div>
          </div>
      ...
      <div className="p-4 space-y-6">
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>Select what information to share when someone taps your device</CardDescription>
          </CardHeader>
          <CardContent className="space-y-4">
            ...
            {currentTemplate && (
              <div className="p-3 bg-gray-50 rounded-lg">
                ...
                <p className="text-sm text-gray-600 mb-2">{currentTemplate.description}</p>
        ...
        <Card className="border-blue-200 bg-blue-50">
          <CardHeader>
            ...
            <CardDescription>Find nearby Linkaroo users automatically without touching devices</CardDescription>
          </CardHeader>
          <CardContent>
            <div className="flex items-center space-x-3 mb-4">
              ...
              <div className="flex-1">
                <h4 className="font-medium text-blue-900">Auto-Discovery</h4>
                <p className="text-sm text-blue-700">Detect users within 10 meters range</p>
              </div>
            </div>
            <Link href="/proximity">
        ...
        <Card>
          <CardHeader>
            <CardTitle className="text-base">Connection Methods Comparison</CardTitle>
          </CardHeader>
          <CardContent>
            <div className="grid grid-cols-1 gap-3">
              <div className="flex items-center gap-3 p-3 bg-orange-50 rounded-lg border border-orange-200">
                ...
                <div className="flex-1">
                  <p className="font-medium text-orange-900">NFC Tap-to-Share</p>
                  <p className="text-sm text-orange-700">Instant connection with physical tap • 4cm range</p>
                </div>
                <Badge className="bg-orange-600 text-white">Fastest</Badge>
              </div>

              <div className="flex items-center gap-3 p-3 bg-blue-50 rounded-lg border border-blue-200">
                <Radar className="h-5 w-5 text-blue-600" />
                <div className="flex-1">
                  <p className="font-medium text-blue-900">Proximity Detection</p>
                  <p className="text-sm text-blue-700">Auto-discover nearby users • 10m range</p>
                </div>
                <Badge className="bg-blue-600 text-white">Automatic</Badge>
              </div>

              <div className="flex items-center gap-3 p-3 bg-green-50 rounded-lg border border-green-200">
                <QrCode className="h-5 w-5 text-green-600" />
                <div className="flex-1">
                  <p className="font-medium text-green-900">QR Code Sharing</p>
                  <p className="text-sm text-green-700">Works on all devices • Longer range</p>
                </div>
                <Badge className="bg-green-600 text-white">Universal</Badge>
              </div>
            </div>
          </CardContent>
        </Card>
        ...
        <Card>
          <CardHeader>
            <CardTitle className="text-base">Recent NFC Connections</CardTitle>
            <CardDescription>Contacts shared via NFC tap-to-share</CardDescription>
          </CardHeader>
          <CardContent>
              ...
              {recentConnections.map((connection) => {
                ...
                return (
                  <div key={connection.id} className="flex items-center gap-3 p-3 bg-gray-50 rounded-lg">
                    <div className={`w-2 h-2 rounded-full ${template?.color || "bg-gray-400"}`}></div>
                    <div className="flex-1">
        ...
        <Card>
          <CardHeader>
            <CardTitle className="text-base">Alternative Sharing Methods</CardTitle>
          </CardHeader>
          <CardContent>
            <div className="grid grid-cols-3 gap-3">
              <Link href="/share">
                <Button variant="outline" className="w-full justify-center bg-transparent flex-col h-16 p-2">
        ...
        <Card className="border-green-200 bg-green-50">
          <CardContent className="p-4">
            <div className="flex items-start space-x-2">
              ...
              <div>
                <h4 className="text-sm font-medium text-green-900 mb-1">Advanced Security</h4>
